...
<html lang="en" ng-app="optionsPortfolio">
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
       ...
       <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/reset.css">
            ...
            <link href="${pageContext.servletContext.contextPath}/webjars/bootstrap/css/bootstrap.min.css" rel="stylesheet">
            <link href="${pageContext.servletContext.contextPath}/webjars/flat-ui/bcaf2de95e/css/flat-ui.css" rel="stylesheet">
            <link href="${pageContext.servletContext.contextPath}/css/portfolio.css" rel="stylesheet">
...
<div class="container" ng-controller="OptionsPortfolioController">
    ...
    <div ng-model="mvolres" class="ng-pristine ng-untouched ng-valid">
        <header class="main-header group">
            ...
            <div class="header-block nav-area">
                <ul class="group">
                 <c:if test="${empty participantRole}">
                    <li ><a href="#" onClick="getPage2('welcomeSAdmin');">Subscription View</a></li>
                    <li ><a href="#" onClick="getPage2('addSubscription');">New Subscription</a></li>
                  ...
                  <c:if test="${not empty participantRole}">
                      <li><a href="#" onClick="getPage2('welcomeParticipant');">Current Portfolio</a></li>
                      <li  class="active" ><a href="#" onClick="getPage2('manageMarket');">Trade</a></li>
            ...
            <div class="header-block misc-area">
                <ul class="group">
                    <li><a onClick="getPage('logout')" href="#">Sign out</a></li>
                    <li><a ng-href="#" href="#">Hello, <span class="ng-binding">${user.firstName} &nbsp;&nbsp;${user.lastName}</span></a></li>
                </ul>
            </div>
        ...
        <main>
           <div class="content_big">
                ...
                <tbody><tr>
                        ...
                        <td><div ng-cloak>{{positions['${optionDetail.optionDetailId}'].callBidPrice}}</div></td>
                        <!--<td class="ylwbg"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${optionDetail.callAskPrice}"/></td>-->
                         <td><div ng-cloak>{{positions['${optionDetail.optionDetailId}'].callAskPrice}}</div></td>
                        ...
                        <!--<td class="nobg"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${optionDetail.putBidPrice}"/></td>-->
                         <td><div ng-cloak>{{positions['${optionDetail.optionDetailId}'].putBidPrice}}</div></td>
                        <!--<td class="nobg"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${optionDetail.putAskPrice}"/></td>-->
                        <td><div ng-cloak>{{positions['${optionDetail.optionDetailId}'].putAskPrice}}</div></td>
