angular.module('optionsPortfolio.services', [])
    ...
    .factory('StompClient', ['sockJsProtocols', '$q', function (sockJsProtocols, $q) {
        ...
        var wrappedSocket = {
            ...
            init: function (url) {
                ...
                console.debug('sockJsProtocols is '+ sockJsProtocols);
    ...
    .factory('OptionsTradeService', ['StompClient', '$q', function (stompClient, $q) {
        ...
        return {
            ...
            loadPositions: function() {
                console.debug('about to call app/optionPositions');
                return stompClient.subscribeSingle("/app/optionPositions");
            },
            fetchQuoteStream: function () {
                return stompClient.subscribe("/topic/price.option.*");
            },
