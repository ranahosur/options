angular.module('springPortfolio.controllers', ['ui.bootstrap'])
    ...
    function ($scope, $uibModal, tradeService) {
        ...
        tradeService.connect("/Options/portfolio")
            .then(function (username) {
                    console.debug('username found '+username);
                    username = 'paulson';
                    console.debug('username now is '+username);
                    $scope.username = 'paulson';
                    console.debug(' $scope.username '+$scope.username);
